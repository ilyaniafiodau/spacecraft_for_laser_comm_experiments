...
target_altitude_km = 281.56          # целевая орбита (высота над поверхностью Земли)
...
print(f"Радиус целевой орбиты: {r_1_km:.2f} км")
print(f"Радиус начальной орбиты: {r_2_km:.2f} км")
print(f"Орбитальная скорость на целевой орбите: {vel_orb_1_km_s:.3f} км/с")
print(f"Орбитальная скорость на начальной орбите: {vel_orb_2_km_s:.3f} км/с")
print(f"Скорость в перигее эллиптической орбиты: {vel_perigee_km_s:.3f} км/с")      
print(f"Скорость в апогее эллиптической орбиты: {vel_apogee_km_s:.3f} км/с")
